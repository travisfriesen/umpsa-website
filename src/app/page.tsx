    ...
    <div>
      ...
      <div className={`flex bg-gold-100 text-gold-950 h-fit min-h-full`}>
        <div className={`my-10 mx-[12.5vw] text-xl space-y-6`}>
          ...
          <p>This site serves as a space to explore those ideas—old and new—that challenge, provoke, and illuminate. Whether you're a seasoned student of philosophy or simply curious about the big questions, we invite you to join the conversation. Here, reflection isn't a retreat from life; it's a way of engaging more deeply with it.</p>
        </div>
      </div>
      <Footer />
    </div>
